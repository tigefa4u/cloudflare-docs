...
<RelatedProduct header="Artifacts" href="/artifacts/" product="artifacts">

Store versioned file trees behind a Git-compatible interface — and use Workflows to run CI pipelines and health-mediated deployments on top of them.
