...
<LinkTitleCard title="CI" href="/artifacts/ci/" icon="document">
	Run CI pipelines on Cloudflare by defining build, test, and deploy steps in cloudflare.ci.ts.
</LinkTitleCard>

<LinkTitleCard title="Deployments" href="/artifacts/deployments/" icon="document">
	Roll out Workers progressively with health-mediated deployments orchestrated as Workflows.
</LinkTitleCard>
